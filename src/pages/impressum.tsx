...
export default function ImpressumPage() {
  return (
    <Layout>
      <div className="container"> {/* Container für zentrierten Inhalt */}
        <h1>Impressum</h1>
        ...
        <main>
          <div className="section">
            ...
            <p><strong>Kontakt:</strong><br />
              ...
              E-Mail: <a href={`mailto:[Ihre E-Mail-Adresse]`}>[Ihre E-Mail-Adresse]</a><br />
          ...
          <div className="section">
            ...
            <p><strong>Haftung für Links:</strong><br />
              Unsere Webseite enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. Für die Inhalte der verlinkten Seiten sind ausschließlich deren Betreiber verantwortlich.
            </p>
          </div>

          <div className="section">
            <h2>Urheberrecht</h2>
            <p>Die durch die Seitenbetreiber erstellten Inhalte und Werke auf dieser Webseite unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers.</p>
          </div>

          <div className="section">
            <h2>Datenschutz</h2>
            <p>Bitte beachten Sie unsere <a href="/datenschutz">Datenschutzerklärung</a>, die weitere Informationen zum Umgang mit Ihren personenbezogenen Daten enthält.</p>
          </div>
