...
export default function DatenschutzPage() {
  return (
    <Layout>
      ...
      <p>
        Verantwortlich für die Datenverarbeitung ist [Name des Unternehmens],
      ...
      <ul>
        ...
        <li>
          Art. 6 Abs. 1 lit. f DSGVO, soweit die Verarbeitung zur Wahrung unserer
      ...
      <h2>8. Aktualisierung der Datenschutzerklärung</h2>
